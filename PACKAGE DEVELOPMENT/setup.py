...
setup(
  name = 'invoicing-pdfs',         #* Your package will have this name
  ...
  author = 'Sergio Manzano',                   # Your name
  author_email = 'smanzano250800@gmail.com',  # Your email
  url = 'https://github.com/SergioManzano10/Python/tree/main/PACKAGE%20DEVELOPMENT',              # Homepage of your library (e.g. github or your website)
